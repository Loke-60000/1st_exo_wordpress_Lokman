...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230103_scamy_87b3e9c32ac9e4e73912_20230103103015_archive.zip';
        const ARCHIVE_SIZE       = '31338077';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '87b3e9c-03103015';
        const SECONDARY_PACKAGE_HASH = 'd838ae4-03103015';
        const VERSION            = '1.5.1';
